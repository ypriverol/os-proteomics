...
In addition to all these misconceptions and complexity, journals mandate code availability as a publication requirement, which has prompted multiple bad practices from software developers and bioinformaticians aiming to futfill the journal's requirements. 
